    ...
    render() {
        return (
            <div style={{backgroundColor: 'black', width: "100%", height: "100vh" }}>
                ...
                <button onClick={() => { this.props.changePage('homepage', 'gamepage'); this.props.musicOn.play(); }} style={{ textAlign: "center", position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'orange', border: 'solid 1px black', padding: '10px', fontSize: '24px' }} >START</button>
            </div>
        )
    }
}
